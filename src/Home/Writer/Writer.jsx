...
const Writer = () => {
    return (
        <div>
              <p className=' w-32 lg:w-2/12 mx-auto my-4 l lg:my-6 text-sm lg:text-2xl bg-[#AD6A34] text-white text-center rounded-tr-xl shadow-lg'> Masterpiece Writers</p>
            <div className="grid grid-cols-3 lg:grid-cols-6 gap-2">
                <section className="rounded-lg flex bg-gray-100 py-1 gap-3">
